...
if(!isset($_SESSION['newIteams'])){
  $_SESSION['newIteams'] = array();
}

if (isset($_POST["addToCart"])) {
  array_push($_SESSION['newIteams'], $_POST);
  ...
  <div id="body">
    <?php require_once('topNav.php');?>
      ...
      <div class="mainContect">
        <h1>Shopping Cart</h1>
        <form method="post">
          <input type="submit" name="addToCart" value="addToCart" readonly>
          <input type="text" name="itemName" value="sword" readonly>
          <input type="text" name="itemPrice" value="10" readonly><br>
        </form>
        <form method="post">
          <input type="submit" name="addToCart" value="addToCart" readonly>
          <input type="text" name="itemName" value="shield" readonly>
          <input type="text" name="itemPrice" value="15" readonly><br>
        </form>
